...
describe("typed", function() {
  ...
  it("serialize_guid_little_test", function() { // 0a369037-75d3-b24d-6721-5a1d44d4bed5
  ...
  it("serialize_datetime_null_little_test", function() { // 0Nz
    assert.equal(bin_to_hexstr(c.serialize(typed.datetime(null))), "0100000011000000f1000000000000f8ff");
  });
  it("serialize_timespan_little_test", function() { // 00:01:00.000000000
